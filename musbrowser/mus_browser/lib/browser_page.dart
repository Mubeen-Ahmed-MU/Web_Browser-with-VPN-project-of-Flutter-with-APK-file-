...
//adding a access of search value
  ...
  //creating top widget like search field, home button and clear button
  _buildTopWidget() {
    return Padding(
...
//creating webpage loading widget
  _buildLoadingWidget() {
    return Container(
      height: 2,
      color: Colors.grey,
...
//creating botom widget like back, forward and reload button
  _buildBottomWidget() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(
            icon: Icon(Icons.reply_outlined), label: "Reload"),
      ],
